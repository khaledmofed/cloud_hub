...
const Services = [
  {
    Id: "1",
    sImg: sImg1,
    title: "Hosting and Domains Services",
    slug: "Hosting-and-Domains-Services",
    thumb1: "Hosting",
    thumb2: "Domains",
    col: "col-lg-6",
    description:
      "نقدم حلول استضافة متكاملة تشمل الاستضافة المشتركة، VPS، Cloud Hosting، استضافة WordPress، إدارة السيرفرات، حجز الدومينات، وإدارة DNS.",
  },
  {
    Id: "2",
    sImg: sImg2,
    ...
    col: "col-lg-6",
    description:
      "نساعد الشركات على التحول الرقمي من خلال أنظمة ERP، CRM، أتمتة العمليات، وربط الأنظمة المختلفة.",
  },

  {
    ...
    thumb1: "E-Commerce",
    thumb2: "Custom Systems",
    col: "col-lg-4",
    description:
      "نطور جميع أنواع المواقع الإلكترونية: مواقع الشركات، المتاجر الإلكترونية، أنظمة الحجوزات، لوحات التحكم المخصصة، مواقع التعليم الإلكتروني وغيرها.",
  },
  {
    Id: "4",
    sImg: sImg4,
    ...
    col: "col-lg-4",
    description:
      "نقدم خدمات أمن سيبراني شاملة: حماية المواقع والسيرفرات، فحص الثغرات، اختبار الاختراق، ومراقبة الخوادم 24/7.",
  },
  {
    Id: "5",
    sImg: sImg5,
    ...
    col: "col-lg-4",
    description:
      "نطور تطبيقات iOS و Android و Web Apps مع خدمات كاملة تشمل تصميم UI/UX، برمجة Backend، API Integration، ورفع التطبيق للمتاجر.",
  },
  {
    Id: "6",
    sImg: icon1,
