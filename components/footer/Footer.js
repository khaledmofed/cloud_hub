            ...
            <div className="row justify-content-lg-between">
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="footer_widget pe-md-3">
                  ...
                  <p>
                    Sign up to Cloud Hub weekly newsletter to get the latest
                    updates.
                  </p>
                  ...
                  <ul className="icon_list unordered_list_block">
                    <li>
                      <Link onClick={ClickHandler} href="/about">
                        <span className="icon_list_text">About Cloud Hub</span>
                      </Link>
                    </li>
                    <li>
      ...
      <div className="footer_bottom">
        <div className="container d-md-flex align-items-md-center justify-content-md-between">
          <p className="copyright_text m-0">
            Copyright © 2026 Cloud Hub, All rights reserved.
          </p>
          <p className="copyright_text m-0">
            Cloud Hub – One Hub, All IT Solutions
          </p>
        </div>
      </div>
    </footer>
