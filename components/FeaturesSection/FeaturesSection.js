...
const getFunFact = (t) => [
  {
    title: "25",
    subTitle: t("features.yearsExperience"),
    symbol: "+",
    icon: sIcon1,
  },
  {
    title: "280",
    subTitle: t("features.successStories"),
    symbol: "+",
    icon: sIcon2,
  },
  {
    title: "5.6",
    subTitle: t("features.companiesTrustUs"),
    symbol: "K+",
    icon: sIcon3,
  },
  {
    title: "100",
    subTitle: t("features.resultsGuaranteed"),
    symbol: "%",
    icon: sIcon4,
  },
];
          ...
          <div className="col-lg-4">
            <div className="our_world_employees">
              <div className="image_wrap">
                <Image src={fimg} alt="Cloud Hub - Employees Guoup" />
              </div>
              <div className="content_wrap">
                <h3 className="title_text mb-0">
                  <b className="d-block">12000+</b>{" "}
                  {t("features.employeesText")}
                </h3>
              </div>
            </div>
          </div>
