...
const testimonial = [
    {
        id: '01',
        Des: "Working with Cloud Hub was a game-changer for our business. Their  tailored solutions and dedicated support propelled us to new heights",
        Title: 'Sarah Johnson',
                            ...
                            <div className="about_image_3">
                                ...
                                <div className="funfact_block capsule_layout">
                                    <div className="funfact_icon">
                                        <Image src={abImg2} alt="Cloud Hub - SVG Icon Wallet" />
                                    </div>
