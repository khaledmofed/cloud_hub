            ...
            <div className="about_content">
              <div className="heading_block mb-0 text-white">
                ...
                <h2 className="heading_text">
                  Cloud Hub <mark>Mission & Goal</mark>
                </h2>
                <p className="heading_description mb-0">
                  At Cloud Hub, our mission is to empower businesses through innovative software solutions that streamline operations, foster growth, and drive success. With a commitment to excellence and customer satisfaction we strive.
                </p>
              </div>
            </div>
          </div>
            ...
            {Project.slice(6, 9).map((project, prj) => (
              <div className="case_study_block" key={prj}>
                <div className="case_study_image">
                  <Image src={project.pImg} alt="Cloud Hub - Cases" />
                </div>
