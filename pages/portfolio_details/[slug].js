  ...
  return (
    <Fragment>
      ...
      <main className="page_content about-page">
        <PageTitle
          pageTitle={PortfolioDetails ? getProjectTitle(PortfolioDetails) : ""}
          pagesub={t("portfolioDetails.details")}
          pageTop={t("portfolioDetails.portfolio")}
        />
        <section className="portfolio_details_section section_space bg-light">
          <div className="container">
            ...
            <h2 className="details_item_title">
              {t("portfolioDetails.cloudMigrationTitle")}
            </h2>
            <p>{t("portfolioDetails.cloudMigrationDesc1")}</p>
            <p className="mb-0">{t("portfolioDetails.cloudMigrationDesc2")}</p>
            <hr />
            <ul className="portfolio_details_info_list icon_list unordered_list justify-content-lg-between mb-5">
              ...
              <li>
                <span className="icon_list_text">
                  <strong className="text-dark text-uppercase">
                    {t("portfolioDetails.completedDate")}:
                  </strong>
                  20-12-2024
                </span>
              </li>
            ...
            <h3 className="details_item_info_title pt-4">
              {t("portfolioDetails.projectRequirement")}
            </h3>
            <p>{t("portfolioDetails.requirementDesc")}</p>
            ...
            <h3 className="details_item_info_title pt-4">
              {t("portfolioDetails.solutionResult")}
            </h3>
            <p>{t("portfolioDetails.solutionDesc1")}</p>
            <p>{t("portfolioDetails.solutionDesc2")}</p>

            <h3 className="details_item_info_title pt-5 mb-4">
              {t("portfolioDetails.similarProjects")}
            </h3>
            <div className="row">
